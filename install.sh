...
IS_WSL=$(grep -q microsoft /proc/version && echo true || echo false)
DOTFILES_MODE="${DOTFILES_MODE:-${IS_WSL:+home-wsl}}"
...
if [ -d "$DOTFILES_DIR" ]; then
  echo "Applying Home Manager configuration $DOTFILES_MODE..."
